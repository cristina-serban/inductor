...
namespace smtlib {
    namespace sep {
        ...
        public:
            ...
            VisitorWithStack0(SymbolStackPtr stack)
                    : stack(std::move(stack))
                    , config(std::make_shared<Configuration>()) {}

            VisitorWithStack0(ConfigurationPtr config)
                    : stack(std::make_shared<SymbolStack>())
                    , config(std::move(config)) {}

            VisitorWithStack0(SymbolStackPtr stack, ConfigurationPtr config)
                    : stack(std::move(stack))
                    , config(std::move(config)) {}
        ...
        public:
            DummyVisitorWithStack0() = default;

            DummyVisitorWithStack0(SymbolStackPtr stack)
                    : VisitorWithStack0(std::move(stack)) {}

            DummyVisitorWithStack0(ConfigurationPtr config)
                    : VisitorWithStack0(std::move(config)) {}

            DummyVisitorWithStack0(SymbolStackPtr stack, ConfigurationPtr config)
                    : VisitorWithStack0(std::move(stack), std::move(config)) {}
        ...
        typedef std::shared_ptr<DummyVisitorWithStack0> DummyVisitorWithStack0Ptr;
    }
}
