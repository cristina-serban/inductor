...
#ifndef INDUCTOR_GLOBAL_VALUES_H
#define INDUCTOR_GLOBAL_VALUES_H
...
extern const std::string KW_ASSERT;
extern const std::string KW_CHK_SAT_ASSUM;
extern const std::string KW_CHK_SAT;
extern const std::string KW_CHK_UNSAT;
extern const std::string KW_DECL_CONST;
extern const std::string KW_DECL_DATATYPE;
extern const std::string KW_DECL_DATATYPES;
extern const std::string KW_DECL_FUN;
extern const std::string KW_DECL_SORT;
extern const std::string KW_DECL_HEAP;
extern const std::string KW_DEF_FUNS_REC;
extern const std::string KW_DEF_FUN_REC;
extern const std::string KW_DEF_FUN;
extern const std::string KW_DEF_SORT;
extern const std::string KW_ECHO;
extern const std::string KW_EXIT;
extern const std::string KW_GET_ASSERTS;
extern const std::string KW_GET_ASSIGNS;
extern const std::string KW_GET_INFO;
extern const std::string KW_GET_MODEL;
extern const std::string KW_GET_OPT;
extern const std::string KW_GET_PROOF;
extern const std::string KW_GET_UNSAT_ASSUMS;
extern const std::string KW_GET_UNSAT_CORE;
extern const std::string KW_GET_VALUE;
extern const std::string KW_POP;
extern const std::string KW_PUSH;
extern const std::string KW_RESET_ASSERTS;
extern const std::string KW_RESET;
extern const std::string KW_SET_INFO;
extern const std::string KW_SET_LOGIC;
extern const std::string KW_SET_OPT;
...
extern const std::string PROOF_TRUE;
extern const std::string PROOF_FALSE;
extern const std::string PROOF_IND;

#endif //INDUCTOR_GLOBAL_VALUES_H
